...
// شبكة "هيرو" (hero) — بطاقة رئيسية مستقلّة + شبكة RTL غير متماثلة من 9 عناصر. مُستخرَجة حرفيًّا
// (copy-move) من فرع layout==='hero' السابق داخل CategoryFeaturedGrid (Renderer Consolidation،
// B2.3a) — لا تغيير بصريّ، نفس الأصناف/البنية/ترتيب الشبكة تمامًا. الـHelpers المحليّان
// (CategoryHeroGridCard/CategoryMegaPostCard) بقيا هنا داخل نفس الملفّ في هذه المرحلة (B2.3a) —
// نقلهما إلى ملفّاتهما الخاصّة، إن احتيج، هو نطاق B2.3b منفصل، لا هذه المرحلة.
