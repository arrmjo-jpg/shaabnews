...
// (لا منطق) يُطابق '@/app/(site)/news/writer/[idslug]/page' — تحقّق عند أي تعديل هناك.
export const revalidate = 36000;
export { default, generateStaticParams, generateMetadata } from '@/app/(site)/news/writer/[idslug]/page';
