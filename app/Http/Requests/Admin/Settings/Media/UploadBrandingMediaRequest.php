...
class UploadBrandingMediaRequest extends BaseFormRequest
{
    ...
    {
        return [
            'logo_light' => ['required_without_all:logo_dark,logo_light_en,logo_dark_en,logo_light_sports,logo_dark_sports,favicon,watermark_image', 'file', 'image', 'mimes:png,webp,jpg,jpeg', 'mimetypes:image/png,image/jpeg,image/webp', 'max:2048'],
            ...
            'logo_light_sports' => ['sometimes', 'file', 'image', 'mimes:png,webp,jpg,jpeg', 'mimetypes:image/png,image/jpeg,image/webp', 'max:2048'],
            'logo_dark_sports' => ['sometimes', 'file', 'image', 'mimes:png,webp,jpg,jpeg', 'mimetypes:image/png,image/jpeg,image/webp', 'max:2048'],
